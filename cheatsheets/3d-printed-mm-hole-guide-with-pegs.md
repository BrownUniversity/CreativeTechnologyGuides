...
* Please note, that the hole guide provided is technically only accurate for the filament it was printed on and the printer it was printed on, which is the Prusa Mk4S in the PML and Elegoo Gray PLA. While it is still relatively reliable to use with other PLA and Printers, there may be a slight margin of error.&#x20;
